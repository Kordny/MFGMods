...
public class SceneTurboSkip : BaseTweak
{
    ...
    public override string Description => "Skips some scenes to make playing faster. Specific scenes can be chosen under [Tweaks.TurboSceneSkip]";
    ...
    {
        GachaSkip = Config.Bind("Tweaks.TurboSceneSkip", "Gacha", true, "Skips the gacha screen animation");
        LogoSkip = Config.Bind("Tweaks.TurboSceneSkip", "Logo", true, "Skips the logos shown before the title screen");
        GameOverSkip = Config.Bind("Tweaks.TurboSceneSkip", "GameOver", true, "Skips the game over screen");
        CautionSkip = Config.Bind("Tweaks.TurboSceneSkip", "Caution", true, "Skips the caution screen before home menu");
    }
